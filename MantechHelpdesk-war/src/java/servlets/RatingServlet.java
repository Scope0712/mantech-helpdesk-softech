...
//        TbTechnicalArticlesFacade.edit(myTbTechnicalArticles);
        ...
        response.sendRedirect("faces/publish/ShowAllArticles.xhtml");
//        try {
//            out.println("<html>");
//            out.println("<head>");
...
//            out.println("<h1>Value of Rate : " + rate + "</h1>");
//            out.println("<h1>Value ID of Article : " + articleid + "</h1>");
//            out.println("<h1>Content of Article : " + myTbTechnicalArticles.getContent() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        } finally {
//            out.close();
